...
@Component({
  selector: 'app-listeformationsprofesseur',
  templateUrl: './listeformationsprofesseur.component.html',
  styleUrls: ['./listeformationsprofesseur.component.scss']
})
export class ListeformationsprofesseurComponent implements AfterViewInit {
constructor() { }
